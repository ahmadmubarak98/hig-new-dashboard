...
/* Route Landlords */
    Route::group(['prefix' => 'landlord'], function () {
        Route::get('/', 'frontend\LandlordController@all')->name('all-landlords');
        Route::get('create', 'frontend\LandlordController@create')->name('create-landlord');
        Route::get('/{id}', 'frontend\LandlordController@view')->name('view-landlord');
        Route::get('{id}/delete', 'frontend\LandlordController@delete')->name('delete-landlord');
        Route::get('{id}/edit', 'frontend\LandlordController@edit')->name('edit-landlord');
        Route::post('/', 'frontend\LandlordController@store')->name('store-landlord');
        Route::put('/', 'frontend\LandlordController@update')->name('update-landlord');
    });
