    ...
    <section id="multiple-column-form">
        <div class="row">
            <div class="col-md-12 col-lg-6 ">
                <div class="card">
                    <div class="card-body">
                        <form class="form" method="post" action="/management/contract" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="landlord_id" id="landlord_id" class="select2 form-control">
                                            <option value="0">HIG</option>
                                            @foreach ($landlords as $item)
                                                <option value="{{ $item['id'] }}"
                                                    {{ $responseBody['landlord'] ? ($item['id'] == $responseBody['landlord']['id'] ? 'selected="selected"' : '') : 'HIG' }}>
