...
@section('title', 'Create New Property Type')
    ...
    <section class="">
        <div class="mb-2 row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <a href="/management/property-type">
    ...
    <section id="multiple-column-form">
        <div class="row">
            <div class="col-md-12 col-lg-6 ">
                <div class="card">
                    <div class="card-body">
                        <form class="form" method="post" action="/management/property-type" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
