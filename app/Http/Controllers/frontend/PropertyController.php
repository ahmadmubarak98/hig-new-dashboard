...
class PropertyController extends Controller
{
    public function all()
    {
        ...
        $url = \Config::get('constants.API_URL') . "/v1/property";
    ...
    {
        $client = new \GuzzleHttp\Client(); //GuzzleHttp\Client
        $url = \Config::get('constants.API_URL') . "/v1/property?leased=1";
    ...
    {
        $client = new \GuzzleHttp\Client(); //GuzzleHttp\Client
        $url = \Config::get('constants.API_URL') . "/v1/property?listed=1";
    ...
    function empty() {
        $client = new \GuzzleHttp\Client(); //GuzzleHttp\Client
        $url = \Config::get('constants.API_URL') . "/v1/property?leased=0";
    ...
    public function create()
    {
        ...
        // Get property list
        $properties = \Config::get('constants.API_URL') . "/v1/property";
