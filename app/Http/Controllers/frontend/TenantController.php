...
class TenantController extends Controller
{
    public function all()
    {
        ...
        $url = \Config::get('constants.API_URL') . "/v1/tenant";
        ...
        return view('/dashboard/tenants/all', compact('responseBody'));
    }

    public function view($id)
    {
        $client = new \GuzzleHttp\Client(); //GuzzleHttp\Client
        $url = \Config::get('constants.API_URL') . "/v1/tenant/" . $id;
        ...
        return view('/dashboard/tenants/view', compact('responseBody'));
    }

    public function delete($id)
    {
        $client = new \GuzzleHttp\Client(); //GuzzleHttp\Client
        $url = \Config::get('constants.API_URL') . "/v1/tenant/" . $id . "/delete";
        ...
        if (200 === $statuscode) {
            return redirect()->route('all-tenants')
    ...
    public function create()
    {
        ...
        return view('/dashboard/tenants/create', ['nationalities' => $nationalities]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('/dashboard/tenants/edit', ['responseBody' => $responseBody, 'nationalities' => $nationalities]);
    }
    ...
    public function update(Request $request)
    {
        ...
        // Send request
        $client = new \GuzzleHttp\Client();
        $url = \Config::get('constants.API_URL') . "/v1/tenant/" . $id . "/update";
        $response = $client->post($url, [
            'http_errors' => false,
            'multipart' => $output
            ,
